...
const (
	OrderService_CreateOrder_FullMethodName       = "/tribecart.v1.OrderService/CreateOrder"
	OrderService_GetOrder_FullMethodName          = "/tribecart.v1.OrderService/GetOrder"
	OrderService_ListOrders_FullMethodName        = "/tribecart.v1.OrderService/ListOrders"
	OrderService_UpdateOrderStatus_FullMethodName = "/tribecart.v1.OrderService/UpdateOrderStatus"
	OrderService_CancelOrder_FullMethodName       = "/tribecart.v1.OrderService/CancelOrder"
	OrderService_GetOrderHistory_FullMethodName   = "/tribecart.v1.OrderService/GetOrderHistory"
)
...
type OrderServiceClient interface {
	...
	GetOrderHistory(ctx context.Context, in *GetOrderHistoryRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error)
}
...
func (c *orderServiceClient) GetOrderHistory(ctx context.Context, in *GetOrderHistoryRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListOrdersResponse)
...
type OrderServiceServer interface {
	...
	// Get order history for a user
	GetOrderHistory(context.Context, *GetOrderHistoryRequest) (*ListOrdersResponse, error)
}
...
func (UnimplementedOrderServiceServer) GetOrderHistory(context.Context, *GetOrderHistoryRequest) (*ListOrdersResponse, error) {
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tribecart.v1.OrderService",
	...
	Metadata: "tribecart/v1/orders.proto",
}
